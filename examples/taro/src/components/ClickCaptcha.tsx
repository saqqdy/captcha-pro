...
import { Canvas, Text, View, CoverView } from '@tarojs/components'
  ...
  return (
    <View className="captcha-container">
      ...
      >
        ...
        {/* Click markers - use cover-view to overlay canvas */}
        ...
        {showRefresh && (
          <CoverView className="refresh-btn" onClick={(e) => { e.stopPropagation(); refresh() }}>
