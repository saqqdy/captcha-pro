...
/**
 * uni-app Slider Captcha Composable (Vue 3)
 *
 * Based on @captcha-pro/mp-shared state management.
 * Touch interaction is handled by the component layer (movable-view).
 */
