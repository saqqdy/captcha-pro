...
export class SliderCaptcha implements SliderCaptchaInstance {
	...
	private async loadImages(): Promise<void> {
		...
		try {
			...
			// Note: generateSliderPiece is called in drawBackground for frontend mode
	...
	private drawBackground(img: HTMLImageElement): void {
		...
		// Only generate slider piece in frontend mode
		// In backend mode, images are already generated by server
